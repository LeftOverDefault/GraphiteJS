...
let surfaceVelocity = new graphitejs.math.Vector2(0, 1)
let surfaceAcceleration = new graphitejs.math.Vector2(0, 1)
...
function loop() {
    ...
    surfaceVelocity.y += surfaceAcceleration.y
    // rect.y = surfaceVelocity.y / clock.getDeltaTime();
